...
import {format, getMinutes, getUnixTime} from "date-fns";
      ...
      {days.map((day, dayIndex) =>
        day.cells.map((cell, cellIndex) => (
          <button
            ...
            className="relative border-t border-gray-100 transition-colors cursor-pointer hover:bg-slate-100 disabled:cursor-not-allowed disabled:bg-slate-50"
            style={{
